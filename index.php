...
<body>
  ...
  <div class="bande">
    <div class="container">
      ...
      <?php include("Experiences/presentation.php"); ?>
    </div>
  </div>
  <div class="bande">
    <div class="container">
      <!-- Section Formation -->
      <?php include("Experiences/formation.php"); ?>
    </div>
  </div>
  <div class="bande">
    <div class="container">
      <!-- Section Experiences professionnelles -->
  		<?php include("Experiences/expro.php"); ?>
    </div>
  </div>
  <div class="bande">
    <div class="container">
      <!-- Section Langues -->
  		<?php include("Experiences/langues.php"); ?>
    </div>
  </div>
  <div class="bande">
    <div class="container">
      <!-- Section Competences Informatiques -->
  		<?php include("Experiences/info.php"); ?>
    </div>
  </div>
  <div class="bande">
    <div class="container">
      <!-- Section Centres d'interet -->
  		<?php include("Experiences/hobbies.php"); ?>
    </div>
  </div>
